...
#### Critères d’acceptation
- Voir les données récentes et historiques
- Paramètres patients éditables
- Score de santé ou indicateur d’état disponible
...
#### Critères d’acceptation
- Affiche les alertes et le statut
- Navigation reste intuitive
